...
public class PointService {
    ...
    @Transactional
    public ResponseEntity<String> completeMission(Long userId, List<MissionType> missions) {
    ...
    // ✅ 날짜 기준으로 오늘 미션 포인트 받은 기록이 있는지만 확인
    ...
    int randomPoint = 1 + new Random().nextInt(10);
